...
# Initialize the registry with default trees
def initialize_registry():
    """Initialize the tree registry with default trees"""
    # Register the default understanding tree
    register_tree(create_default_decision_tree())
    
    # Register specialized trees
